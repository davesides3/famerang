      ...
      <div className="flex-1 flex flex-col overflow-hidden bg-muted/30">
        ...
        <div className="bg-card border-t-2 border-border p-4 flex flex-col gap-4 shrink-0 pb-safe">
          ...
          <div className="flex gap-2 relative">
            ...
            <textarea
              className="flex-1 bg-white border-2 border-border rounded-xl px-10 py-2.5 resize-none h-12 focus:border-primary focus:outline-none font-serif text-lg leading-tight"
